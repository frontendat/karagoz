...
import { m as defineRenderHandler, n as buildAssetsURL, p as publicAssetsURL, o as getQuery, c as createError, q as getRouteRules, u as useRuntimeConfig, r as getResponseStatus, v as getResponseStatusText, w as useNitroApp } from '../nitro/nitro.mjs';
...
const appHead = {"meta":[{"name":"viewport","content":"width=device-width, initial-scale=1"},{"charset":"utf-8"}],"link":[{"rel":"icon","href":"/karagoz-logo.svg","type":"image/svg+xml"}],"style":[],"script":[],"noscript":[]};
